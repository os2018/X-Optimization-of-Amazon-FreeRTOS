<center><h1> Amazon-FreeRTOS 可行性报告 </h1>
...
- [2. 项目分析](#2-项目分析)
    ...
    - [2.2. 实现内容](#22-实现内容)
        ...
        - [2.2.2. 技术依据](#222-技术依据)
        - [2.2.3. 任务调度](#223-任务调度)
        - [2.2.4. 外围通讯库的改写](#224-外围通讯库的改写)
        - [2.2.5. 通过协程减小内存需求 (coroutine)](#225-通过协程减小内存需求-coroutine)
            - [2.2.5.1. 协程的定义](#2251-协程的定义)
            - [2.2.5.2. 协程的由来](#2252-协程的由来)
            - [2.2.5.3. 优势比较](#2253-优势比较)
            - [2.2.5.4. 举例说明](#2254-举例说明)
                - [2.2.5.4.1. 伪代码](#22541-伪代码)
                - [2.2.5.4.2. python 实现如下：](#22542-python-实现如下)
                - [2.2.5.4.3. 执行结果](#22543-执行结果)
                - [2.2.5.4.4. 解释](#22544-解释)
- [3. 参考资料](#3-参考资料)
